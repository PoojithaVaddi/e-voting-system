    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="userlogin.jsp">Logout</a></li>
        </ul>
			   ...
			   <div class="table-wrapper">
					<table class="alt" style=" width:1000px; margin:0;" cellpadding="0" cellspacing="0" border="0">
						...
						try
						{
							...
							String a=(String)session.getAttribute("dis");
							System.out.println("dis : "+a);
							String b=(String)session.getAttribute("sta");
							System.out.println("sta : "+b);
							
							Connection con=DBConnection.getconnection();
							String sql="select * from candidate where district=? and state=?";
							...
							while(rs.next())
							{
								...
								<td><a href="vote.jsp?id=<%=rs.getString("id") %>"><img style="height: 50px;" src="images/click-me-button.png"></a></td>
								</tr>
								<%
							}
						}
