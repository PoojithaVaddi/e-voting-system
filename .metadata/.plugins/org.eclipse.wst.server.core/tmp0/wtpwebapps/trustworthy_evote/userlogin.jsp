    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="userlogin.jsp">Voter</a></li>
        </ul>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          ...
          <div class="col-md-8">
	            <form action="userlogindb.jsp" method="post" role="form">
	              <div class="row">
	    
	                <div class="form-group col-md-12">
	                  <label for="email">Name</label>
	                  <input type="text" name="name" class="form-control" id="email" placeholder="Enter your Name" required><br>
	                </div>
	              ...
	              <a href="userregistration.jsp">new user click here</a>
