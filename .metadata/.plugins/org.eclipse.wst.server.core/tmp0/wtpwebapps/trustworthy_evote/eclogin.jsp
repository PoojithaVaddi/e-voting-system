    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="eclogin.jsp">Election Commission</a></li>
  ...
  <!-- ======= Contact Section ======= -->
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="col-md-8">
	            <form action="eclogindb.jsp" method="post" role="form">
	              <div class="row">
	                <div class="form-group col-md-12">
	                  <label for="email">Your Email</label>
	                  <input type="email" name="email" class="form-control" id="email" placeholder="Enter your email" required><br>
	                </div>
	              ...
	              <a href="zecform.jsp">new user? click here</a>
